...
interface HomePopularMoviesProps {}

const HomePopularMovies: FC<HomePopularMoviesProps> = () => {
    const { data: media, error } = useSWR<MediaData[]>(
        `${process.env.NEXT_PUBLIC_API_URL}/movie/popular?api_key=${process.env.NEXT_PUBLIC_API_KEY}&language=en-US`,
        fetcher
    );
