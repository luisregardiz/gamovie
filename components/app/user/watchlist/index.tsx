...
const WatchList: FC<WatchListProps> = () => {
    ...
    return (
        <>
            <h4 className=" text-gray-400 text-2xl font-black">Watch List</h4>
            <div className="inline-flex bg-gray-900 items-center justify-center space-x-4 md:w-1/4 w-1/2 mx-auto py-3 rounded-3xl shadow-lg text-gray-400 mb-5">
                <button
                    onClick={() => setMovie(false)}
                    className={`font-bold text-sm ${
                        !isMovie &&
                        "bg-gray-700 text-gray-200 px-3 py-1 rounded-2xl text-sm"
                    }`}
                >
                    Movies
                </button>
                <button
                    ...
                    className={`font-bold text-sm ${
                        isMovie &&
                        "bg-gray-700 text-gray-200 px-2 py-1 rounded-2xl text-sm"
                    }`}
                >
                    TV Shows
                </button>
