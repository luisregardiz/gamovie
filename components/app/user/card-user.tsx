...
const CardMediaUser: FC<CardMediaUserProps> = ({
    ...
    return (
        <div
            key={media.id}
            className="flex relative shadow-lg  rounded-lg p-4 w-full bg-gray-900 text-gray-200"
        >
            <Image
                src={
                    imageError
                ...
                <div className="flex flex-col items-center  space-y-2 my-2">
                    <div>
                        <button
                            ...
                            className="text-gray-400 border-2 border-gray-700 rounded-full h-8 w-8 flex items-center justify-center hover:bg-gray-700 hover:text-gray-200 "
                        >
                            <XIcon className="w-5" />
                        </button>
                    </div>
