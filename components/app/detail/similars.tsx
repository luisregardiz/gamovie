...
const SimilarContent: FC<SimilarContentProps> = ({ id, media_type }) => {
    const { data: media, error } = useSWR<MediaData[]>(
        `${process.env.NEXT_PUBLIC_API_URL}/${media_type}/${id}/similar?api_key=${process.env.NEXT_PUBLIC_API_KEY}&language=en-US`,
        fetcher
    );
