            ...
            <div>
                ...
                <div className="space-y-5">
                    <button
                        ...
                        className="px-4 py-2 text-sm rounded-xl shadow-lg bg-gray-900 text-gray-200 font-semibold flex items-center"
                    >
                        Filter movies
                    ...
                    {showFilters && (
                        <form
                            ...
                            className="bg-gray-900 bg-opacity-90 backdrop-filter backdrop-blur-md flex flex-col p-5 absolute z-20 rounded-xl shadow-xl md:w-1/2 w-3/4 space-y-5 "
                        >
                            ...
                            <button
                                type="submit"
                                className="px-4 py-2 rounded-lg flex items-center justify-center bg-gray-900 font-semibold text-gray-200"
                            >
                                Filter
