...
const Movie: NextPage<MovieProps> = () => {
    ...
    return (
        <section className="min-h-screen bg-gray-800 px-2">
            <Head>
            ...
            <div className="flex md:flex-row flex-col items-center justify-between bg-gray-900 p-5 rounded-lg shadow-lg gap-5 md:w-3/4 w-4/5 mx-auto ">
